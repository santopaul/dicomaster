...
def safe_colored(
    text: str, color: str | None = None, on_color: str | None = None, attrs: list[str] | None = None
) -> str: ...
def show_banner(args: argparse.Namespace | bool = True, font: str | None = None) -> None: ...
def process_and_save(
    path: str, args: argparse.Namespace, mappings: dict[str, Any] | None = None
) -> dict[str, Any] | None: ...
...
def pretty_print_stat(
    stat: dict[str, Any], full: dict[str, Any], color: bool = True, detail: bool = False
) -> None: ...
def create_html_report(
    stat: dict[str, Any], full: dict[str, Any], thumbnail_path: str | None = None
) -> str: ...
